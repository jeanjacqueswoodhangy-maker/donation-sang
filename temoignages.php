...
<html lang="fr">
  <head>
    ...
    <meta property="og:title" content="Témoignages - Don de Sang Solidaire">
    <meta property="og:description" content="Plateforme locale pour encourager le don de sang en Haïti.">
    <meta property="og:type" content="website">
    <title>Témoignages - Don de Sang Solidaire</title>
...
<section class="content-section testimonials-section" id="temoignages">
        <div class="section-heading">
          <div><p class="eyebrow">Témoignages</p><h2>Ils ont choisi de participer</h2></div>
        </div>
        <div class="testimonial-grid">
          <article><p>"J'avais peur au début, mais l'équipe m'a accompagnée du début à la fin."</p><strong>Marline, donneuse</strong></article>
          <article><p>"Une demande partagée rapidement nous a aidés à trouver des donneurs compatibles."</p><strong>Samuel, proche de patient</strong></article>
          <article><p>"Organiser une collecte dans notre école a motivé beaucoup de jeunes."</p><strong>Nadine, responsable communautaire</strong></article>
        </div>
      </section>
    </main>
